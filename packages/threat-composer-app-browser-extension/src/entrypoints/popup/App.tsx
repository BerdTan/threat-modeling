...
import { getExtensionConfig, setExtensonConfig } from '../../common';

const App: FC = () => {
  const [intearationRawEnabled, handleConfigChange] = React.useState(getExtensionConfig().integrationRaw);
  const [integrationGitHubBrowserEnabled] = React.useState(getExtensionConfig().integrationGitHubCodeBrowser);
        ...
        <Container>
          <SpaceBetween size="xs">
            ...
            <ColumnLayout columns={2}>
              <div>
                <Toggle
                  onChange={({ detail }) => handleConfigChange(detail.checked)}
